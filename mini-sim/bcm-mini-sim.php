...
function bcm_mini_sim_shortcode($atts = array()) {
    ...
    <div class="bcm-mini-sim" style="--bcm-sim-height:<?php echo esc_attr($atts['height']); ?>;">
        ...
        <div class="bcm-mini-sim-hud">
            <div class="bcm-mini-sim-title">SPACE LABYRINTH — PLAYABLE TEST 0.50</div>
        ...
        <div class="bcm-mini-sim-settings" hidden>
            <div class="bcm-mini-sim-settings-card">
                ...
                <p>Портал запускается сам, когда его квадрат виден минимум на 69% при подходе. G / Y остаётся ручным запуском. Во время ролика управление заблокировано; после ролика — телепорт в следующую зону.</p>
