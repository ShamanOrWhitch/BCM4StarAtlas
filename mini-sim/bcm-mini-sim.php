...
define('BCM_MINI_SIM_VERSION', '0.5.9');
...
function bcm_mini_sim_enqueue_assets()
{
    ...
    wp_localize_script('bcm-mini-sim', 'BCMMiniSimConfig', array(
        ...
        'spaceVideoZones' => array(
            array('url' => 'https://walkingyog.com/wp-content/uploads/2025/11/30Сек43-1.mp4', 'x' => -4.8, 'y' => 1.2, 'z' => -35.5, 'radius' => 8, 'maxWidth' => 6.6, 'maxHeight' => 4.2),
            array('url' => 'https://walkingyog.com/wp-content/uploads/2025/12/Jah-Love-480P.mp4', 'x' => 4.8, 'y' => 1.2, 'z' => -40.0, 'radius' => 8, 'maxWidth' => 6.6, 'maxHeight' => 4.2),
            array('url' => 'https://walkingyog.com/wp-content/uploads/2026/09/We-gonna-rockit-копия-копия27.mp4', 'x' => -4.8, 'y' => 1.2, 'z' => -44.5, 'radius' => 8, 'maxWidth' => 6.6, 'maxHeight' => 4.2),
            array('url' => 'https://walkingyog.com/wp-content/uploads/2026/05/Speed-reshade-rasta-dance61.mp4', 'x' => 4.8, 'y' => 1.2, 'z' => -48.0, 'radius' => 7, 'maxWidth' => 6.6, 'maxHeight' => 4.2),
        ),
        'assets' => $assets,
...
function bcm_mini_sim_shortcode($atts = array())
{
    ...
    <div class="bcm-mini-sim" style="--bcm-sim-height:<?php echo esc_attr($atts['height']); ?>;">
        ...
        <div class="bcm-mini-sim-hud">
            <div class="bcm-mini-sim-title">SPACE LABYRINTH — 0.5.9</div>
