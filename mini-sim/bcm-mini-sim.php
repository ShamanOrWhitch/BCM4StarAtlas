...
define('BCM_MINI_SIM_VERSION', '0.7.7');
...
function bcm_mini_sim_shortcode($atts = array())
{
    ...
    <div class="bcm-mini-sim" style="--bcm-sim-height:<?php echo esc_attr($atts['height']); ?>;">
        ...
        <div class="bcm-mini-sim-hud">
            <div class="bcm-mini-sim-title">SPACE LABYRINTH — 0.7.7</div>
        ...
        <div class="bcm-mini-sim-settings" hidden>
            <div class="bcm-mini-sim-settings-card">
                ...
                <p>Телефон: кнопки дают движение, свайп по экрану — ручной поворот камеры, наклон — плавный поворот обзора. Невидимая центральная зона фиксирует ближайший экран. G у портала запускает переход по подходу к порталу.</p>
