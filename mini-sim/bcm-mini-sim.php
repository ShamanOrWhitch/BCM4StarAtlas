...
define('BCM_MINI_SIM_VERSION', '0.7.4');
...
function bcm_mini_sim_shortcode($atts = array())
{
    ...
    <div class="bcm-mini-sim" style="--bcm-sim-height:<?php echo esc_attr($atts['height']); ?>;">
        ...
        <div class="bcm-mini-sim-hud">
            <div class="bcm-mini-sim-title">SPACE LABYRINTH — 0.7.4</div>
        ...
        <div class="bcm-mini-sim-settings" hidden>
            <div class="bcm-mini-sim-settings-card">
                ...
                <p>Телефон: кнопки по краям дают движение и вертикаль, свайп по экрану — поворот, наклон телефона — поворот камеры. Наклон калибруется автоматически после «Играть»; TILT — повторная калибровка.</p>
